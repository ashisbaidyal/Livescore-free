...
// .wrangler/tmp/pages-mpwgFw/functionsWorker-0.2384928324161537.mjs
...
__name2(normalizeSportParam, "normalizeSportParam");
...
__name2(normalizeLeagueParam, "normalizeLeagueParam");
...
__name2(getDefaultLeague, "getDefaultLeague");
...
__name2(getTargetSports, "getTargetSports");
...
__name2(siteWebApiUrl, "siteWebApiUrl");
...
__name2(isIplLeague, "isIplLeague");
...
__name2(getIplScoreboardUrl, "getIplScoreboardUrl");
...
__name2(fetchLeagueScoreboard, "fetchLeagueScoreboard");
...
__name2(fetchLeagueStandings, "fetchLeagueStandings");
...
__name2(buildFeedMeta, "buildFeedMeta");
...
__name2(calculateTTL, "calculateTTL");
...
__name2(buildFallbackUrls, "buildFallbackUrls");
...
__name2(parseDateRange, "parseDateRange");
...
__name2(extractLeagueName, "extractLeagueName");
...
__name2(normalizeArticle, "normalizeArticle");
...
__name2(normalizeScoreboardEvent, "normalizeScoreboardEvent");
...
__name2(normalizeTeamEntry, "normalizeTeamEntry");
...
__name2(normalizeRosterGroups, "normalizeRosterGroups");
...
__name2(resolveTeamFromRef, "resolveTeamFromRef");
...
__name2(normalizeStandingsEntries, "normalizeStandingsEntries");
var SPORT_LABELS = {
  all: "All Sports",
  soccer: "Soccer",
  football: "Football",
...
__name2(getLeaguePairs, "getLeaguePairs");
function toTimestamp(value = "") {
  const parsed = new Date(value).getTime();
  return Number.isFinite(parsed) ? parsed : 0;
}
__name(toTimestamp, "toTimestamp");
__name2(toTimestamp, "toTimestamp");
...
__name2(extractDomain, "extractDomain");
...
__name2(getSourceFavicon, "getSourceFavicon");
...
__name2(trimSentence, "trimSentence");
...
__name2(buildLeagueLabel, "buildLeagueLabel");
...
__name2(buildScoreboardDates, "buildScoreboardDates");
...
__name2(fetchEditorialArticles, "fetchEditorialArticles");
...
__name2(fetchContextMatches, "fetchContextMatches");
...
__name2(scoreMatchAgainstArticle, "scoreMatchAgainstArticle");
...
__name2(findRelatedMatch, "findRelatedMatch");
...
__name2(pickVertical, "pickVertical");
...
__name2(buildKeywords, "buildKeywords");
...
__name2(buildExcerpt, "buildExcerpt");
...
__name2(buildSections, "buildSections");
...
__name2(buildReadingTime, "buildReadingTime");
...
__name2(buildSectionBuckets, "buildSectionBuckets");
...
__name(getLeaguePairs2, "getLeaguePairs2");
__name2(getLeaguePairs2, "getLeaguePairs");
function toTimestamp2(value = "") {
  const parsed = new Date(value).getTime();
  return Number.isFinite(parsed) ? parsed : 0;
}
__name(toTimestamp2, "toTimestamp2");
__name2(toTimestamp2, "toTimestamp");
var IPL_ROLE_LABELS = {
  batters: "Batter",
...
__name2(normalizeIplKey, "normalizeIplKey");
...
__name2(deriveShortName, "deriveShortName");
...
__name2(getIplRoleMeta, "getIplRoleMeta");
...
__name2(extractIplPlayerNames, "extractIplPlayerNames");
...
__name2(buildIplPlayer, "buildIplPlayer");
...
__name2(aliasIplStandingEntry, "aliasIplStandingEntry");
...
__name2(findIplStat, "findIplStat");
...
__name2(getIplTeamsDirectory, "getIplTeamsDirectory");
...
__name2(getIplRosterDirectory, "getIplRosterDirectory");
...
__name2(getNormalizedIplStandings, "getNormalizedIplStandings");
...
__name2(getNormalizedIplTeams, "getNormalizedIplTeams");
...
__name2(getNormalizedIplPlayers, "getNormalizedIplPlayers");
...
__name2(getNormalizedIplTeamProfile, "getNormalizedIplTeamProfile");
...
__name2(getNormalizedIplAthleteProfile, "getNormalizedIplAthleteProfile");
...
__name2(getNormalizedNews, "getNormalizedNews");
...
__name2(getNormalizedStandings, "getNormalizedStandings");
...
__name2(getNormalizedTeams, "getNormalizedTeams");
...
__name2(getNormalizedPlayers, "getNormalizedPlayers");
...
__name2(resolveTeamId, "resolveTeamId");
...
__name2(getNormalizedTeamProfile, "getNormalizedTeamProfile");
...
__name2(getNormalizedAthleteProfile, "getNormalizedAthleteProfile");
...
__name2(getNormalizedScores, "getNormalizedScores");
...
__name2(buildEndpoints, "buildEndpoints");
...
__name2(sortMatches, "sortMatches");
...
__name2(buildInternalApiUrl, "buildInternalApiUrl");
...
__name2(fetchInternalJson, "fetchInternalJson");
...
__name2(buildSummaryCandidates, "buildSummaryCandidates");
function buildScoreboardCandidates(sport, league) {
  const normalizedSport = normalizeSportParam(sport, league);
  const normalizedLeague = normalizeLeagueParam(league, normalizedSport);
  const candidates = [];
  const dates = parseDateRange(6);
  const pushPair = /* @__PURE__ */ __name2((candidateSport, candidateLeague) => {
    if (!candidateSport || !candidateLeague) return;
    if (candidates.some((entry) => entry.sport === candidateSport && entry.league === candidateLeague)) return;
    candidates.push({ sport: candidateSport, league: candidateLeague });
  }, "pushPair");
...
__name2(buildScoreboardCandidates, "buildScoreboardCandidates");
...
__name2(getCompetitionContext, "getCompetitionContext");
...
__name2(normalizeStatValue, "normalizeStatValue");
...
__name2(buildStatPairs, "buildStatPairs");
...
__name2(formatLeaderValue, "formatLeaderValue");
...
__name2(buildSyntheticStatsFromContext, "buildSyntheticStatsFromContext");
...
__name2(buildSyntheticLineupFromLeaders, "buildSyntheticLineupFromLeaders");
...
__name2(buildLineupFromBoxscore, "buildLineupFromBoxscore");
...
__name2(inferTimelineSide, "inferTimelineSide");
...
__name2(formatTimelineDate, "formatTimelineDate");
...
__name2(buildSyntheticTimelineFromContext, "buildSyntheticTimelineFromContext");
...
__name2(buildSyntheticLineupFromTeam, "buildSyntheticLineupFromTeam");
...
__name2(buildSyntheticStatsFromMatch, "buildSyntheticStatsFromMatch");
...
__name2(buildSyntheticTimelineFromMatch, "buildSyntheticTimelineFromMatch");
...
__name2(normalizeStats, "normalizeStats");
...
__name2(normalizeLineup, "normalizeLineup");
...
__name2(normalizeTimeline, "normalizeTimeline");
...
__name2(normalizeOdds, "normalizeOdds");
...
__name2(normalizeSummary, "normalizeSummary");
...
__name2(normalizeFallbackScoreboardSummary, "normalizeFallbackScoreboardSummary");
...
__name2(normalizeFeedFallbackSummary, "normalizeFeedFallbackSummary");
...
__name2(hasUsefulSummaryText, "hasUsefulSummaryText");
...
__name2(isGenericTeam, "isGenericTeam");
...
__name2(needsSummaryHydration, "needsSummaryHydration");
...
__name2(pickSummaryText, "pickSummaryText");
...
__name2(mergeSummaryPayload, "mergeSummaryPayload");
...
__name2(buildTeamKeySet, "buildTeamKeySet");
function isSameMatchup(match2 = {}, homeTeam = {}, awayTeam = {}) {
  ...
  const hasKeyMatch = /* @__PURE__ */ __name2((left, right) => [...left].some((value) => right.has(value)), "hasKeyMatch");
...
__name2(isSameMatchup, "isSameMatchup");
...
__name2(formatHeadToHeadDate, "formatHeadToHeadDate");
...
__name2(buildHeadToHeadFallback, "buildHeadToHeadFallback");
...
__name2(findFeedFallback, "findFeedFallback");
...
__name2(findScoreboardFallback, "findScoreboardFallback");
...
__name(getLeaguePairs3, "getLeaguePairs3");
__name2(getLeaguePairs3, "getLeaguePairs");
function toTimestamp3(value = "") {
  const parsed = new Date(value).getTime();
  return Number.isFinite(parsed) ? parsed : 0;
}
__name(toTimestamp3, "toTimestamp3");
__name2(toTimestamp3, "toTimestamp");
...
__name(stripHtml2, "stripHtml2");
__name2(stripHtml2, "stripHtml");
function slugify3(value = "") {
  return String(value || "").toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-+|-+$/g, "");
}
__name(slugify3, "slugify3");
__name2(slugify3, "slugify");
function deriveShortName2(fullName = "") {
  const parts = String(fullName || "").trim().split(/\s+/).filter(Boolean);
  if (parts.length <= 2) return parts.join(" ");
  return `${parts[0]} ${parts[parts.length - 1]}`;
}
__name(deriveShortName2, "deriveShortName2");
__name2(deriveShortName2, "deriveShortName");
...
__name2(getIplPlayers, "getIplPlayers");
...
__name2(parsePastDateRange, "parsePastDateRange");
...
__name2(buildResultsEndpoints, "buildResultsEndpoints");
...
__name(getLeaguePairs4, "getLeaguePairs4");
__name2(getLeaguePairs4, "getLeaguePairs");
...
__name(aliasIplStandingEntry2, "aliasIplStandingEntry2");
__name2(aliasIplStandingEntry2, "aliasIplStandingEntry");
...
__name(getLeaguePairs5, "getLeaguePairs5");
__name2(getLeaguePairs5, "getLeaguePairs");
...
__name2(getIplTeams, "getIplTeams");
...
__name2(buildUpcomingEndpoints, "buildUpcomingEndpoints");
...
__name(buildInternalApiUrl2, "buildInternalApiUrl2");
__name2(buildInternalApiUrl2, "buildInternalApiUrl");
...
__name2(fetchSubscriptionJson, "fetchSubscriptionJson");
var CHANNEL_CONFIG = {
...
async function onRequest11(context) {
  ...
  __name2(pushChannelData, "pushChannelData");
  ...
  __name2(subscribeChannel, "subscribeChannel");
  ...
  __name2(unsubscribeChannel, "unsubscribeChannel");
  function cleanupAll() {
...
// .wrangler/tmp/bundle-2yJdr4/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-2yJdr4/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.2384928324161537.js.map
