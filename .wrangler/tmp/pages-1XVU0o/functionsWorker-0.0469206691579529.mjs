...
__name(isCacheValid2, "isCacheValid");
...
__name(getCacheKey3, "getCacheKey");
function isCacheValid3(timestamp, ttl) {
  return Date.now() - timestamp < ttl;
}
__name(isCacheValid3, "isCacheValid");
...
__name(fetchWithTimeout3, "fetchWithTimeout");
...
__name(getCacheKey4, "getCacheKey");
function isCacheValid4(timestamp, ttl) {
  return Date.now() - timestamp < ttl;
}
__name(isCacheValid4, "isCacheValid");
...
__name(fetchWithTimeout4, "fetchWithTimeout");
...
__name(pickTeamScore2, "pickTeamScore");
...
__name(buildEvents2, "buildEvents");
...
__name(fetchWithTimeout5, "fetchWithTimeout");
...
__name(fetchWithTimeout6, "fetchWithTimeout");
...
// ../.wrangler/tmp/pages-1XVU0o/functionsRoutes-0.41380872838857674.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-syeswh/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-syeswh/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.0469206691579529.mjs.map
